---
title: "Midterm Exam"
author: "DSO 424. Business Forecasting"
date: "Exam time: 10:00 am - 6:00 pm PST"
output:
  html_document:
    df_print: paged
...
The test is a take-home, open-book, and open-notes. You are not allowed to discuss and/or receive help from anyone either in class or not, either human or not :).

Download Rmd file from Blackboard to include your answers there. Your answers should be clear. Make sure to answer all questions.

You will be asked to submit Rmd file with your solution on BB.
